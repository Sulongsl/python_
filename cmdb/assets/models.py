from django.contrib.auth.models import User  # 引入Django内置的User表
...
class StorageDevice(models.Model):
	...
	asset = models.OneToOneField('Asset',on_delete=models.CASCADE)
	sub_asset_type = models.SmallIntegerField(choices=sub_asset_type_chioce, default=0, verbose_name='存储设备类型')
...
"""日志模型
事件日志不能随着关联资产的删除被一并删除，设置on_delete=models.SET_NULL
"""
